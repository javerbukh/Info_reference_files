...
def check_required_keys_json(json_file):
    required_keywords = ["title", "reftype", "pedigree", "author", "telescope", "exp_type",\
        "instrument", "useafter", "descript", "HISTORY", "msaoper"]
    if set(required_keywords).issubset(set(json_file)):
...
for filename in os.listdir(directory):
    ...
    if filename.endswith(".fits"):
        ...
        try:
            ...
            print ("NOT A VALID FILE")
        if check_required_keys_json(json_file):
